...
// Mounted at /api/customer-groups
router.get("/",          (req, res) => forwardToAI(req, res, "/customer-groups"));
router.post("/classify", (req, res) => forwardToAI(req, res, "/customer-groups/classify"));
